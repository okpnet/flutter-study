...
class AuthService {
  ...
  // Configuration
  static const String _keycloakUrl = 'http://qmspi:8443';
  static const String _realm = 'pms';
  static const String _clientId = 'qual-app';
  static const String _redirectUrl = 'com.example.teste://callback';
  static const List<String> _scope = ['openid', 'profile', 'email'];
  // Token Storage Keys
  ...
  Future<bool> authenticate() async {
    try {
      ...
      final AuthorizationTokenResponse result = await _appAuhth
  ...
  Future<bool> _isTokenExpried() async {
    ...
    final exporation = await DateTime.fromMillisecondsSinceEpoch(
