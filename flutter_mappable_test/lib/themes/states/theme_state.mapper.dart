...
class ThemeStateMapper extends ClassMapperBase<ThemeState> {
  ...
  static PairThemeData _$currentTheme(ThemeState v) => v.currentTheme;
  static const Field<ThemeState, PairThemeData> _f$currentTheme = Field(
    'currentTheme',
    _$currentTheme,
    mode: FieldMode.member,
  );
  ...
  static ThemeState _instantiate(DecodingData data) {
    return ThemeState(
      themePath: data.dec(_f$themePath),
...
class _ThemeStateCopyWithImpl<$R, $Out>
  ...
  ThemeState $make(CopyWithData data) => ThemeState(
    themePath: data.get(#themePath, or: $value.themePath),
